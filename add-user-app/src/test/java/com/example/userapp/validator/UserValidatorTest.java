 ...
 * 
 * We don't test the model specific validation since we already test it in
...
public class UserValidatorTest {
    ...
    /**
     * Test failure of validation in case adult user not conform. Asserts that there
     * is 3 errors since our 3 fields have errors (not birthday or gender)
     */
    @Test
    ...
    /**
     * Test failure of validation in case minor user not conform. Asserts that there
     * is 4 errors since our 4 fields have errors (date format right but user not an
     * adult)
     */
    @Test
