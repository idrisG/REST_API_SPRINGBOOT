...
class UserControllerIntegrationTest {
	...
	User user = new User("hubert_test","01/01/1996","France","0102030405","male");
	...
	public void testRetireveUser() {
		...
		ResponseEntity<String> response = restTemplate.exchange(createUrlWithPort("/getUser/"+user.getUsername()), 
				HttpMethod.GET, entity, String.class);
		assertEquals(HttpStatus.FOUND,response.getStatusCode());
		
		response = restTemplate.exchange(createUrlWithPort("/getUser/wrong"), 
				HttpMethod.GET, entity, String.class);
